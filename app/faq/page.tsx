...
const faqs: FaqItem[] = [
  ...
  },
  {
    question: "這些工具是否免費？",
    answer:
      "目前開店小工具箱提供的試算工具可以免費使用。未來若新增其他服務、廣告或合作內容，仍會以網站頁面實際說明為準。",
  },
  {
...
export const metadata: Metadata = {
  ...
  title: "常見問題",
  description:
    "開店小工具箱常見問題：整理試算結果使用方式、餐飲毛利率、外送平台抽成、開店成本、資料儲存、免費使用與錯誤回報等說明。",
  keywords: [
    "開店小工具箱常見問題",
    "餐飲毛利率問題",
    "開店工具 FAQ",
  ...
  openGraph: {
    title: "常見問題｜開店小工具箱",
    description:
      "整理開店小工具箱的試算結果、資料儲存、免費使用、外送抽成、開店成本與錯誤回報等常見問題。",
    type: "website",
    locale: "zh_TW",
    siteName: "開店小工具箱",
    images: [
