...
export const metadata: Metadata = {
  title: "開店工具總覽",
  description:
    "開店小工具箱整理餐飲店、小吃店、飲料店常用的免費試算工具，包含滿額加購活動計算器、餐飲毛利率計算器與折扣活動損益計算器。",
  keywords: [
    "開店工具",
    "餐飲工具",
    "餐飲毛利率計算器",
  ...
  openGraph: {
    title: "開店工具總覽｜開店小工具箱",
    description:
      "整理小店老闆常用的營運試算工具，包含滿額加購、餐飲毛利率與折扣活動損益試算。",
    type: "website",
    locale: "zh_TW",
    siteName: "開店小工具箱",
  },
        ...
        <section className="mx-auto max-w-5xl px-6 py-12">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-stone-700">
              ...
              幫助你在推出活動、調整售價或設計促銷前，先把毛利、成本與銷量算清楚。
            </p>
          </div>
